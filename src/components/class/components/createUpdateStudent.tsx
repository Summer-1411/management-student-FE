...
import '../index.scss'
import { ClassContextProps, CreateUpdateStudentProps } from '../types';
...
const CreateUpdate: React.FC<CreateUpdateStudentProps> = (props: CreateUpdateStudentProps) => {
  const { edit, initValue, setEdit } = useClass() as ClassContextProps
  const { open, setOpen, classInfor, formCreateUpdate } = props
      ...
      <Form layout="vertical" hideRequiredMark form={formCreateUpdate} onFinish={onFinish}>
        ...
        <Row gutter={16}>
          <Col span={24}>
            ...
            >
              <Input placeholder="Nhập tên lớp" disabled />
            </Form.Item>
          </Col>
          <Col span={24}>
            {edit && <Image
